...
var EtsyItemsCollection = Backbone.Collection.extend({
  ...
  initialize: function(){
    ...
    this.hipstermaticFetch = function(fetchObject){
      ...
      $('.page-title').append('<p class="small search-again cleared-out">too many people know about this already?     <button type="button" class="btn btn-default btn-lg hipstermatic-search-btn"> Be Unique-er, search again</button></p>');
